...
const Infrastructure = () => {
  return (
    ...
    <div class="container xl:px-20 md:px-6 px-4 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Building to <br/> accomodate 100+ Startups</h1>
        ...
        <div class="mt-8 xl:mt-12 lg:flex lg:items-center">
            ...
            <div class="hidden lg:flex lg:w-1/2 lg:justify-center">
                <Image class="w-[28rem] h-[28rem] flex-shrink-0 object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" width={448} height={448}/>
            </div>
        </div>
    </div>
</section>
