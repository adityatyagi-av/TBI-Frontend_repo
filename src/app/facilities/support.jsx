...
const Support = () => {
  return (
      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <h1 className="relative text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Legal and Marketing<span className="text-blue-900"> Support</span></h1>
          </span>{' '}
    ...
    <h1 className="text-2xl font-semibold text-center my-10 text-gray-800 capitalize lg:text-3xl dark:text-white">Intellectual Property<span className="text-blue-900"> Rights</span></h1>
