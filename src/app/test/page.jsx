              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <h2 className="text-4xl font-black text-black mb-4 dark:text-white">
                    Incubate in our  <span className="text-blue-600 dark:text-blue-500"> HealthCare Schemes</span>!
                  </h2>
                  <h3 className="text-xl leading-relaxed font-medium text-gray-700 dark:text-gray-300">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam ex alias quasi id accusamus provident, ad, distinctio dolores, minus non deserunt soluta delectus. Quibusdam reiciendis ab et iusto totam doloremque blanditiis voluptatum laborum veritatis rerum sapiente adipisci, nam neque earum!
                  </h3>
                </div>
                {/* END Heading */}
