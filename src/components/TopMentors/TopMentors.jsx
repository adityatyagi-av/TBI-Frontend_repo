                ...
                {mentorsData.map((mentor, index) => {
                    return (
                        <div key={index} className="p-3">
                            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-900">
                                <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={mentor.imageSrc} alt={mentor.name} />

                                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize group-hover:text-white">{mentor.name}</h1>

                                <p class="mt-2 text-gray-500 capitalize group-hover:text-gray-300">{mentor.position}</p>
