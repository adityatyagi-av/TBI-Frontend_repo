...
const mentorsData = [
    ...
    },
    {
        ...
        imageSrc: 'https://images.unsplash.com/photo-1531590878845-12627191e687?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80',
        name: 'Amelia Richarlison',
        position: 'CE0, Some Company',
    }, {
        imageSrc: 'https://images.unsplash.com/photo-1531590878845-12627191e687?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80',
        name: 'Amelia Jamieson',
        position: 'CE0, Some Company',
    }, {
        imageSrc: 'https://images.unsplash.com/photo-1531590878845-12627191e687?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80',
                ...
                {mentorsData.map((mentor, index) => {
                    return (
                        <div key={index} className="p-3">
                            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-900">
                                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={mentor.imageSrc} alt={mentor.name} />

                                <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize group-hover:text-white">{mentor.name}</h1>

                                <p className="mt-2 text-gray-500 capitalize group-hover:text-gray-300">{mentor.position}</p>
