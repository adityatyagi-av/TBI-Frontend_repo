        ...
        <div className="parent py-7">
            ...
            >
                {testimonialsData.map((testimonial, index) => {
                    return (
                        <div key={index} class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
