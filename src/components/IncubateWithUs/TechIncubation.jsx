...
function TechIncubation() {
    return (   
        <>
     <h1 className="max-w-2xl self-center mx-auto font-poppins font-semibold sm:text-[52px] text-[32px] text-headingColor ">Technical <span className='text-secondary'>Incubation</span></h1>
            ...
            <div className="mx-auto container flex justify-center items-center py-12 px-4 sm:px-6 2xl:px-0">
                    <div className="flex flex-col lg:flex-row justify-center items-center space-y-6 lg:space-y-0">
                        <div className="w-80 sm:w-auto flex flex-col justify-start items-start">
                            <div>
                                <p className="text-3xl xl:text-4xl font-semibold leading-9 ">Incubate in <span className='text-blue-900'>Technical</span> Schemes</p>
                            </div>
