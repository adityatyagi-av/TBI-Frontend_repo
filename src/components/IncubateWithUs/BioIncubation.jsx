        ...
        <section className="px-3 py-14 w-full overflow-x-hidden mb-1 ">
            <div className="grid max-w-screen-2xl px-4 py-6 mx-auto lg:gap-8 xl:gap-0 lg:py-13 lg:grid-cols-12">
                ...
                <div className="ml-auto place-self-center lg:col-span-7 ">
                    <h1 className="max-w-2xl font-poppins font-semibold sm:text-[52px] text-[32px] text-headingColor ">Bio <span className='text-secondary'>Incubation</span></h1>
                    ...
                    <Link href='/incubation/healthcare'>
